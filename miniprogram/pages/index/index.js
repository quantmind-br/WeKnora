...
Page({
  data: {
    ...
    needsSettingsText: "Configure the WeKnora API base URL and API key before loading knowledge bases.",
    openSettingsText: "Open Settings",
    knowledgeBaseLabel: "Knowledge Base",
    tapToSelectText: "Tap to select",
    refreshText: "Refresh knowledge bases",
    urlLabel: "URL",
    urlPlaceholder: "https://github.com/Tencent/WeKnora",
    importUrlText: "Import URL",
    displayKnowledgeBaseName: "Tap to select",
    importing: false,
    knowledgeBases: [],
    knowledgeBaseNames: [],
    loading: false,
