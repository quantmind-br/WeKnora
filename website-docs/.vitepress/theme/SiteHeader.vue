...
const docsNavigation = [
  { label: 'Quick Start', href: '/docs/01-getting-started/03-quickstart', section: '/docs/01-getting-started/' },
  { label: 'Architecture', href: '/docs/02-architecture/01-overview', section: '/docs/02-architecture/' },
  { label: 'Features', href: '/docs/03-features/01-tenant-auth', section: '/docs/03-features/' },
  { label: 'API', href: '/docs/04-api/01-api-overview', section: '/docs/04-api/' },
  { label: 'Clients', href: '/docs/05-clients/01-frontend', section: '/docs/05-clients/' },
  { label: 'Development', href: '/docs/06-development/01-dev-guide', section: '/docs/06-development/' },
  { label: 'Releases', href: '/docs/07-releases/v0.8.2', section: '/docs/07-releases/' },
]
...
<template>
  <header class="wk-header wk-docs-header">
    <div class="wk-header-inner">
      <a class="wk-brand" href="/" target="_self" aria-label="WeKnora home"><span class="wk-logo"><img :src="`${homeAssets}/brand/weknora-original.png`" alt="WeKnora" width="945" height="650"></span></a>
      <nav id="main-navigation" class="wk-navigation" :class="{ 'is-open': open }" aria-label="Docs navigation">
      ...
      <button ref="menu" class="wk-menu-toggle" type="button" :aria-label="open ? 'Close navigation' : 'Open navigation'" :aria-expanded="open" aria-controls="main-navigation" @click="open = !open"><HeaderIcon :name="open ? 'close' : 'menu'" /></button>
    </div>
  </header>
</template>
