...
export interface ParserEngineConfig {
  ...
  // MinerU self-hosted parameters (protocol auto-detected: 4.0+ uses the V1 API)
  mineru_server_api_key?: string
  mineru_tier?: string // flash / basic / standard / advanced; empty means server default
  // The following only apply to MinerU 3.x and earlier
  mineru_model?: string
