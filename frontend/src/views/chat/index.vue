...
.chat {
    // No horizontal padding, so the scrollbar sits flush against the rightmost edge of the content area;
    // the message column and the input column each use --chat-content-inset for symmetric left/right spacing (only visible on narrow screens).
    padding: 0;
