...
// Add member: look up by full space ID.
...
// Create mode uses a compact form and role comparison, reusing the member-management permission definitions.
...
<style lang="less">
// Scoped to the create dialog, preserving the layout of the existing shared-space settings page.
