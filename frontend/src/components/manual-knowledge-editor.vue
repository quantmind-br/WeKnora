...
/* Narrow drawer: rather than letting the toolbar wrap (the view switch would dangle on a second line), collapse the view switch into icons
   so everything still fits on one line. Tooltips cover the text meaning. */
.manual-editor--narrow {
  ...
  /* Fallback for extremely narrow widths: wrap only when it truly doesn't fit, instead of hiding buttons in a hidden scrollbar */
  .editor-toolbar {
    flex-wrap: wrap;
  }
