...
// desktopAboutVersion prefers handler.Version injected by the build script, otherwise tries to read VERSION from the repo root (for local wails dev etc. without ldflags).
