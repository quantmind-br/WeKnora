...
type ModelParameters struct {
	...
	// CustomHeaders lets you attach custom HTTP headers when calling the remote
	...
	// WeKnoraCloud vendor-specific credentials
	AppID     string `yaml:"app_id,omitempty"     json:"app_id,omitempty"`
	AppSecret string `yaml:"app_secret,omitempty" json:"app_secret,omitempty"` // AES-256 encrypted storage that actually holds the upstream API Key
