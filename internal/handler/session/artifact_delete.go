...
// @Summary      Delete an artifact file in a session
// @Description  Deletes a single file generated by an assistant message; with all_versions=true, every earlier version of that file in this session is deleted too
// @Tags         Sessions
// @Produce      json
// @Param        session_id    path   string  true   "Session ID"
// @Param        message_id    path   string  true   "Message ID"
// @Param        index         path   int     true   "Position of the artifact within the message"
// @Param        all_versions  query  bool    false  "Whether to delete all versions of the file"
...
// @Summary      Delete a file from the artifact library
// @Description  Deletes a file from the artifact library. Each library row represents the latest version of a file, so by default every earlier version of that file in the session is deleted too
// @Tags         Sessions
// @Produce      json
// @Param        session_id    query  string  true   "Session ID"
// @Param        message_id    query  string  true   "Message ID"
// @Param        index         query  int     true   "Position of the artifact within the message"
// @Param        all_versions  query  bool    false  "Whether to delete all versions; defaults to true"
// @Success      200  {object}  map[string]interface{}
// @Failure      404  {object}  errors.AppError
// @Security     Bearer
