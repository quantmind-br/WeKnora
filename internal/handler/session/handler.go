...
// @Description  Get session list of the current workspace with pagination, keyword search and source/agent filters
// @Tags         Sessions
// @Accept       json
// @Produce      json
// @Param        page       query     int     false  "Page number"
// @Param        page_size  query     int     false  "Items per page"
// @Param        keyword    query     string  false  "Fuzzy title search"
// @Param        source     query     string  false  "Source filter: web / embed / api / feishu / wechat / slack / ... (api, embed and IM channels require Admin+)"
// @Param        agent_id   query     string  false  "Filter by agent (only applies to IM sessions)"
...
// @Produce      json
// @Param        id       path      string         true  "Session ID"
// @Param        request  body      types.Session  true  "Session info"
...
// @Description  Delete all messages in a session, clearing LLM context and chat-history KB entries. The session itself is kept.
// @Tags         Sessions
// @Accept       json
// @Produce      json
// @Param        id   path      string  true  "Session ID"
...
// @Description  Batch delete chat sessions by ID list, or set delete_all=true to delete all sessions in the current workspace
// @Tags         Sessions
// @Accept       json
// @Produce      json
...
// PinSession godoc
// @Summary      Pin session
// @Description  Pin the given session (per user)
// @Tags         Sessions
// @Produce      json
// @Param        session_id   path      string  true  "Session ID"
// @Success      200  {object}  map[string]interface{}  "Pinned successfully"
// @Failure      404  {object}  errors.AppError         "Session does not exist"
// @Security     Bearer
// @Security     ApiKeyAuth
...
// @Description  Unpin the given session
// @Tags         Sessions
// @Produce      json
// @Param        id   path      string  true  "Session ID"
// @Success      200  {object}  map[string]interface{}  "Unpinned successfully"
// @Failure      404  {object}  errors.AppError         "Session does not exist"
// @Security     Bearer
// @Security     ApiKeyAuth
