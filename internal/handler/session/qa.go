...
// @Description  Search the knowledge base (without LLM summarization). Uses the same retrieval pipeline as in-product Q&A (recall, rerank, merge) and is the preferred option for external retrieval; recall parameters and rerank can be overridden
// @Tags         Q&A
// @Accept       json
// @Produce      json
