...
// @Description  Create a new workspace. Any logged-in user can call this to set up their own new workspace.
// @Description  The caller is automatically set as the Owner of the workspace. Cross-workspace super admins can still
// @Description  Any workspace can be created through this endpoint.
// @Description  When tenant.auto_create_api_key (or WEKNORA_TENANT_AUTO_CREATE_API_KEY)
// @Description  When enabled, a full_access API Key is auto-created and its plaintext token is returned in the response data.api_key field.
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Param        request  body      handler.createTenantRequest  true  "Workspace info"
// @Success      201      {object}  map[string]interface{}  "Created workspace (optionally includes api_key)"
...
// @Failure      400  {object}  errors.AppError         "Invalid request parameters"
// @Failure      404  {object}  errors.AppError         "Workspace does not exist"
// @Security     Bearer
// @Security     ApiKeyAuth
...
// @Produce      json
// @Param        id       path      int           true  "Workspace ID"
// @Param        request  body      types.Tenant  true  "Workspace info"
...
// @Summary      Get workspace API Key user-identity configuration
// @Description  Return the configuration of how X-API-Key requests map to terminal Principal (Owner)
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Param        id   path      int  true  "Workspace ID"
...
// @Summary      Update workspace API Key user-identity configuration
// @Description  Configure how X-API-Key requests map to terminal Principal (Owner)
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Param        id       path      int                           true  "Workspace ID"
...
// @Summary      Generate API Playground test JWT
// @Description  Issue a short-lived external-user JWT with the workspace's saved HMAC key (Owner)
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Param        id       path      int                                  true  "Workspace ID"
...
// @Description  Delete the given workspace
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Param        id   path      int  true  "Workspace ID"
...
// @Description  Get workspaces accessible to the current user
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
...
// @Summary      Get all workspace list
// @Description  Get all workspaces in the system (requires cross-workspace access)
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Success      200  {object}  map[string]interface{}  "All workspace list"
// @Failure      403  {object}  errors.AppError         "Insufficient permissions"
// @Security     Bearer
...
// @Description  Paginated workspace search (requires cross-workspace access)
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Param        keyword    query     string  false  "Search keywords"
// @Param        tenant_id  query     int     false  "Workspace ID filter"
...
// GetTenantKV godoc
// @Summary      Get workspace KV configuration
// @Description  Get workspace-level KV configuration (supports web-search-config, prompt-templates, parser-engine-config, storage-engine-config, chat-history-config, retrieval-config)
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
...
// @Summary      Update workspace KV configuration
// @Description  Update workspace-level KV configuration (supports web-search-config, parser-engine-config, storage-engine-config, chat-history-config, retrieval-config)
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
// @Param        key      path      string  true  "Configuration key"
...
// @Summary      Get workspace web search configuration
// @Description  Get the workspace web search configuration
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
...
func (h *TenantHandler) updateTenantParserEngineConfigInternal(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"message": "Parser engine configuration updated",
	})
}
...
func (h *TenantHandler) updateTenantStorageEngineConfigInternal(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"message": "Storage engine configuration updated",
	})
}

// GetPromptTemplates godoc
// @Summary      Get prompt template
// @Description  Get the system-configured prompt template list
// @Tags         Workspace Management
// @Accept       json
// @Produce      json
