...
// @Description  For display on the registration page. No auth required; returns 410 if the token is invalid or revoked.
...
// @Description  The registrant provides their own email (not bound to the token); on success they automatically join the workspace.
// @Tags         Authentication
// @Accept       json
// @Produce      json
// @Param        request  body      registerByInviteRequest  true  "Invite registration request"
