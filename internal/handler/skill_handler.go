...
// @Description  Return the installed skills (ready and enabled) in the given sandbox config image that agents can actually call. The list is empty when sandbox_config_id is omitted.
// @Tags         Skills
// @Accept       json
// @Produce      json
