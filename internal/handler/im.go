...
// @Description  Update the name, mode, reply language, knowledge base, credentials or enabled state of the given IM channel
// @Tags         IM Channels
// @Accept       json
// @Produce      json
// @Param        id       path      string                  true  "Channel ID"
// @Param        request  body      map[string]interface{}  true  "Fields to update (including locale)"
