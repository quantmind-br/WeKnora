...
func AvailableToolDefinitions() []AvailableTool {
	return []AvailableTool{
		...
		{Name: ToolSearchKnowledge, Label: "Search Knowledge Base", Description: "Semantic, keyword, or hybrid search over knowledge base chunks"},
		{Name: ToolReadDocument, Label: "Read Document", Description: "Read document metadata and chunk contents, with pagination and in-document search"},
		{Name: ToolListDocuments, Label: "Browse Documents", Description: "List documents in the knowledge base with pagination"},
		{Name: ToolQueryKnowledgeGraph, Label: "Query Knowledge Graph", Description: "Query relationships from the knowledge graph"},
		{
			...
			Label:       "Review Past Conversations",
			Description: "Find previously discussed content in the user's own past conversations",
		},
