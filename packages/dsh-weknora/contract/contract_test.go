...
func TestResponseFieldsThePluginReadsStillExist(t *testing.T) {
	...
	samples := map[string]any{
		"types.SearchResult": types.SearchResult{
			ID:                "chunk-1",
			Content:           "The default vector_threshold is 0.5",
			KnowledgeID:       "doc-1",
			ChunkIndex:        3,
			KnowledgeTitle:    "retrieval-pipeline.md",
			KnowledgeFilename: "retrieval-pipeline.md",
			Score:             0.83,
		},
		"types.Knowledge": types.Knowledge{
			ID:                "doc-1",
			Title:             "retrieval-pipeline.md",
			FileName:          "retrieval-pipeline.md",
			Description:       "Explains recall and thresholds in WeKnora hybrid retrieval.",
